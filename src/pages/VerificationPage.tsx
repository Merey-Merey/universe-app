...
export const VerificationPage: React.FC = () => {
  ...
  const verify = () => {
    if (!allFilled) {
      setCodeError("Введи все 4 цифры кода");
      triggerShake();
      return;
    }
    ...
    <>
      ...
      <div className="page-wrapper mobile-only">
        ...
        <div className="auth-body auth-body--centeredd">
          ...
          <p className="auth-subtitlee">A 4 digit code has been sent to +91 701*****34</p>
          <OtpRow />
  ...
  <div className="auth-right">
    <div className="form-card">
      ...
      <p
        ...
        style={{ textAlign: "center" }}
      >
        A 4-digit code was sent to +7 701 *** ** 34
      </p>
